  ...
  return (
    <div>
      <div className="skills">
        <h1 className="skills__title"><span className="skills__desc"> 🔥My stack</span></h1>
      </div>
            ...
            <Col xs="6" sm="6" md="3">
              <div data-aos="fade-down">
                ...
                <div className="skills__content">
                  ...
                  <p>TypeScript <img src="https://img.icons8.com/color/typescript.png" alt="javascript-icon" className="skills__img"></img></p>
